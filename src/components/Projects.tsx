  ...
  const projects = [
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=SilverCodeLine",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Hospital+System",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Startup+Project",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Training+System",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Book+Review+App",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=E-Commerce",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Task+Dashboard",
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/400x250/1e293b/0ea5e9?text=Weather+App",
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div key={project.id} className={`card group ${project.featured ? 'ring-2 ring-primary-500' : ''}`}>
              {/* Project Image */}
              <div className="relative overflow-hidden rounded-lg mb-6">
                ...
                <div className="absolute top-4 right-4 bg-dark-800/80 text-gray-300 px-3 py-1 rounded-full text-sm font-medium">
                  {project.status}
                </div>
              </div>
